...
const quickAccess = [
  ...
  { title: 'Nuevo Pedido', image: '/images/pizzas.jpg', link: '/pedidos' },
];
    ...
    <Box sx={{ padding: '20px' }}>
      ...
      >
        {quickAccess.map((item, index) => (
          <Card key={index} sx={{ cursor: 'pointer', width: { xs: '100%', sm: '32%' }, height: '250px' }}>
            <CardMedia component="img" image={item.image} alt={item.title} height="150" style={{ borderRadius: '8px 8px 0 0' }} />
            <CardContent>
